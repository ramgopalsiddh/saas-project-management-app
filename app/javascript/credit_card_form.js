...
$(document).on('ready turbolinks:load', function () {
  ...
  var handlePlanChange = function (plan_type, form) {
    ...
    if (plan_type == undefined) {
      plan_type = $('#account_plan :selected').val();
    }
  ...
  // Setup plan change event listener #account_plan id in the forms for clas cc_form
  $("#account_plan").on('change', function (event) {
    handlePlanChange($('#account_plan :selected').val(), ".cc_form");
  });
